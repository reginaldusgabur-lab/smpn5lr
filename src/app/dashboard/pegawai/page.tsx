    ...
    <div className="space-y-6">
       <div className="space-y-1">
        ...
        {pendingLeaveRequests && pendingLeaveRequests.length > 0 && (
            <Alert variant="default" className="bg-amber-50 border-amber-300 text-amber-900 dark:bg-ambergit status-950/50 dark:border-amber-800 dark:text-amber-200 [&>svg]:text-amber-600 dark:[&>svg]:text-amber-400">
